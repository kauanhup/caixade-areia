...
ApplicationWindow {
    id: mainWindow
    visible: false  // Muda para false primeiro
    width: 1000
    height: 600
    minimumWidth: 1000
    minimumHeight: 600
    maximumWidth: 1000
    maximumHeight: 600
    title: "Caixa de Areia Interativa - Sistema de Visualização Topográfica"
    ...
    // Centraliza e mostra a janela depois
    Component.onCompleted: {
        visibility = Window.Windowed
        x = (Screen.width - width) / 2
        y = (Screen.height - height) / 2
        visible = true
        showNormal()  // Força modo normal
    }
    
    // Cores do tema (baseado no Tailwind CSS do projeto)
    ...
    // Stack de páginas - Carregamento dinâmico
    Loader {
        id: pageLoader
        anchors.fill: parent
