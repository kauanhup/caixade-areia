...
void Aula_3::keyPressEvent(QKeyEvent *e)
{
...
void Aula_3::on_btn_modelo_1_clicked()
{
    imgSelecionada = "modelo_1.png";
    TrocarImg();
}

void Aula_3::on_btn_modelo_2_clicked()
{
    imgSelecionada = "modelo_2.png";
    TrocarImg();
}

void Aula_3::on_btn_modelo_3_clicked()
{
    imgSelecionada = "modelo_3.png";
    TrocarImg();
}

void Aula_3::on_btn_modelo_4_clicked()
{
    imgSelecionada = "modelo_4.png";
    TrocarImg();
}

void Aula_3::on_btn_modelo_5_clicked()
{
    imgSelecionada = "modelo_5.png";
    TrocarImg();
}

void Aula_3::on_btn_modelo_6_clicked()
{
    imgSelecionada = "modelo_6.png";
    TrocarImg();
}

void Aula_3::on_btn_modelo_7_clicked()
{
    imgSelecionada = "modelo_7.png";
    TrocarImg();
}

void Aula_3::on_btn_modelo_8_clicked()
{
    imgSelecionada = "modelo_8.png";
    TrocarImg();
}

void Aula_3::on_btn_projetar_clicked()
{
    this->showImagemFullscreen();
}

void Aula_3::on_btn_visualizar_clicked()
{
    system("~/src/SARndbox-2.8/bin/SARndbox -uhm -fpv &");
}

void Aula_3::on_btn_validar_clicked()
{
...
void Aula_3::showImagemFullscreen()
{
